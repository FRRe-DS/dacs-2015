 ...
 */
package ar.edu.utn.frre.dacs.cuit.impl;
...
import ar.edu.utn.frre.dacs.cuit.CuitValidationService;
 ...
 */
@Stateless
@WebService(endpointInterface="ar.edu.utn.frre.dacs.cuit.CuitValidationService")
//@WebContext(contextRoot="/cuitValidator")
public class SimpleCuitValidatorImpl implements CuitValidationService {
	
	private static final Logger logger = 
			LoggerFactory.getLogger(SimpleCuitValidatorImpl.class); 
